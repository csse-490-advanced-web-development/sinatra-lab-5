...
# - Create a UsersController (reference the TasksController class) **********done
# - Create a route in UsersController that matches the "Sign Up" link route ***/users/new
# - Implement the form for creating a new user      ******done
# - Implement the User class (reference the Task class)   ****done
# - Create a migration to generate the users table        ********did it
