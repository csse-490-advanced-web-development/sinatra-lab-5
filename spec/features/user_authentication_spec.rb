...
feature "User Authentication", js: true do
  scenario "signing up successfully and then logging in" do #, skip: "Step 3: Unskip this test and read the instructions above" do
    visit "/"
    click_link "Sign Up"
  ...
  scenario "sign up failure" do #, skip: "Step 4: Unskip this test and read the instructions above" do
    visit "/"
    click_link "Sign Up"
